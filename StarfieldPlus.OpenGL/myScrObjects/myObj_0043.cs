...
namespace my
{
    ...
    public class myObj_0043 : myObject
    {
        // Priority
        public static int Priority => 33;
		public static System.Type Type => typeof(myObj_0043);
        ...
        protected override void Show()
        {
            ...
            switch (shape)
            {
                ...
                // Instanced triangles
                case 1:
                    myPrimitive._TriangleInst.setInstanceCoords(x, y, 2 * size, 0);
                    myPrimitive._TriangleInst.setInstanceColor(R, G, B, A);
                    break;

                // Instanced circles
                case 2:
                    myPrimitive._EllipseInst.setInstanceCoords(x, y, 2 * size, 0);
                    myPrimitive._EllipseInst.setInstanceColor(R, G, B, A);
                    break;

                // Instanced pentagons
                case 3:
                    myPrimitive._PentagonInst.setInstanceCoords(x, y, 2 * size, 0);
                    myPrimitive._PentagonInst.setInstanceColor(R, G, B, A);
                    break;

                // Instanced hexagons
                case 4:
                    myPrimitive._HexagonInst.setInstanceCoords(x, y, 2 * size, 0);
