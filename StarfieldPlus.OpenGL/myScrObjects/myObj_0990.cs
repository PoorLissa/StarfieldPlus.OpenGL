...
namespace my
{
    public class myObj_0990 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0990);
        ...
        private static List<myObj_0990> sortedList = null;

        private static myObj_0990 parent = null;
        ...
        protected override void initGlobal()
        {
            ...
            sortedList = new List<myObj_0990>();
        ...
        protected override void Move()
        {
            if (id == 0)
            {
                if (--cnt == 0)
                {
                    ...
                    {
                        var obj = sortedList[i] as myObj_0990;
        ...
        {
            sortedList.Sort(delegate (myObj_0990 obj1, myObj_0990 obj2)
            {
...
namespace my
{
    public class myObj_0990 : myObject
    {
        ...
        protected override void generateNew()
        {
            ...
            {
                var parent = list[0] as myObj_0990;
