...
namespace my
{
    public class myObj_0040 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0040);
                ...
                case 2:
                    {
                        ...
                        if (doDrawTwice)
                        {
                            ...
                            myPrimitive._EllipseInst.setInstanceColor(R, G, B, A * 0.33f);
                        }
                    }
                    break;
