...
namespace my
{
    public class myObj_670 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_670);
        ...
        protected override void Move()
        {
            if (id >= n)
            {
                ...
                else
                {
                    ...
                    {
                        var rect2 = list[i2] as myObj_670;
