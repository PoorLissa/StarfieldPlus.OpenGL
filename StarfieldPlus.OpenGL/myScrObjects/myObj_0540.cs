...
/*
    - Falling alphabet letters (Matrix style), ver1
...
namespace my
{
    public class myObj_0540 : myObject
    {
        // --------------------------------------------------------------------------
        ...
        public static System.Type Type => typeof(myObj_0540);
