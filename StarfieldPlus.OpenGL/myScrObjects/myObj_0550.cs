...
namespace my
{
    public class myObj_0550 : myObject
    {
        // Priority
        public static int Priority => 10;
        public static System.Type Type => typeof(myObj_0550);
        ...
        protected override void setNextMode()
        {
            ...
            {
                (list[i] as myObj_0550).generateNew();
            }
        }
