...
namespace my
{
    public class myObj_0181 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0181);
        ...
        protected override void generateNew()
        {
            ...
            else
            {
                ...
                x = (list[parent_id] as myObj_0181).x;
                y = (list[parent_id] as myObj_0181).y;
