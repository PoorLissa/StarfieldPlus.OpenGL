...
namespace my
{
    ...
    public partial class myObj_0440_Ball : myObj_0440 { };

    public class myObj_0440 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0440);
        ...
        protected override void Process(Window window)
        {
            ...
            // Add moving ball
            list.Add(new myObj_0440_Ball());

#if false
            while (list.Count < N)
                list.Add(new myObj_0440());
#endif
