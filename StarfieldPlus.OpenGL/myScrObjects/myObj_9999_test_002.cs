...
namespace my
{
    public class myObj_9999_test_002 : myObject
    {
        class myObj_9999_test_002_Comparer : IComparer<myObj_9999_test_002>
        {
            public int Compare(myObj_9999_test_002 obj1, myObj_9999_test_002 obj2)
            {
                int x1 = (int)obj1.x;
                int x2 = (int)obj2.x;
		...
		public static System.Type Type => typeof(myObj_9999_test_002);
        ...
        private static List<myObj_9999_test_002> sortedList = null;

        // Comparer for a binary search on the sortedList
        private static myObj_9999_test_002_Comparer cmp = new myObj_9999_test_002_Comparer();

        private static object _lock = new object();

        // ---------------------------------------------------------------------------------------------------------------

        public myObj_9999_test_002()
        {
            if (id != uint.MaxValue)
                generateNew();
        }
        ...
        protected override void initGlobal()
        {
            ...
            sortedList = new List<myObj_9999_test_002>();
...
lenMode = 0;
        ...
        protected override void Process(Window window)
        {
            ...
            if (true)
            {
                while (list.Count < N)
                {
                    var obj = new myObj_9999_test_002();
        ...
        private void process2(Window window)
        {
            ...
            Func<object, int> action = (object obj) =>
            {
                ...
                for (int i = beg; i < end; i++)
                    (list[i] as myObj_9999_test_002).showConnectionsThreadSafe();
        ...
        {
            sortedList.Sort(delegate (myObj_9999_test_002 obj1, myObj_9999_test_002 obj2)
            {
