...
namespace my
{
    public class myObj_0900 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0900);
        ...
        private static float lineA = 1, lineWidth = 1, speedFactor = 1;
        ...
        protected override void generateNew()
        {
            ...
            {
                var parent = list[rand.Next(n)] as myObj_0900;
        ...
        protected override void Show()
        {
            ...
            //if (id > n && lastId > n)
            {
                var next = list[lastId] as myObj_0900;
