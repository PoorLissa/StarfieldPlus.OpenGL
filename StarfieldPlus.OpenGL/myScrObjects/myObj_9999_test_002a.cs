...
namespace my
{
    public class myObj_9999_test_002a : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_9999_test_002a);

        private float x, y, dx, dy;
        private float size, A, R, G, B, angle = 0;

        private List<myObj_9999_test_002a> neighbours = null;
        ...
        private static new List<myObj_9999_test_002a> list = null;

        // ---------------------------------------------------------------------------------------------------------------

        public myObj_9999_test_002a()
        {
            if (id != uint.MaxValue)
                generateNew();
        }
        ...
        protected override void initGlobal()
        {
            ...
            list = new List<myObj_9999_test_002a>();
...
A /= 10;
            ...
            {
                neighbours = new List<myObj_9999_test_002a>();
            }
        ...
        protected override void Process(Window window)
        {
            ...
            if (doGenerateAll)
                while (list.Count < N)
                    list.Add(new myObj_9999_test_002a());
        ...
        private void process1(Window window)
        {
            ...
            while (!Glfw.WindowShouldClose(window))
            {
                ...
                // Render Frame
                {
                    ...
                    for (int i = 0; i != Count; i++)
                    {
                        var obj = list[i] as myObj_9999_test_002a;
                        obj.Show();
                        obj.Move();
                    }
        ...
        private void process2(Window window)
        {
            ...
            Func<object, int> action = (object obj) =>
            {
                ...
                for (int i = beg; i < end; i++)
                    (list[i] as myObj_9999_test_002a).showConnectionsThreadSafe(i);
        ...
        {
            list.Sort(delegate (myObj_9999_test_002a obj1, myObj_9999_test_002a obj2)
            {
        ...
        private void showConnectionsThreadSafe(int current_index)
        {
            ...
            for (int i = current_index + 1; i < Count; i++)
            {
                var other = list[i] as myObj_9999_test_002a;
