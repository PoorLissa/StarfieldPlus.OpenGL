...
namespace my
{
    public class myObj_9999_test_001 : myObject
    {
        // Priority
        public static int Priority => 10;
        public static System.Type Type => typeof(myObj_9999_test_001);
        ...
        protected override void Process(Window window)
        {
            ...
            while (!Glfw.WindowShouldClose(window))
            {
                ...
                // Render Frame
                {
                    ...
                    {
                        var obj = list[i] as myObj_9999_test_001;
                ...
                if (Count < N)
                {
                    list.Add(new myObj_9999_test_001());
                }
