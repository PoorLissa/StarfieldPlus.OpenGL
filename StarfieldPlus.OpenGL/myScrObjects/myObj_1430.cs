...
namespace my
{
    ...
    public class myObj_1430 : myObject
    {
        ...
        private static int move2Mode = 0, dirMode = 0, sizeMode = 0, focusMode = 0, focusCntMax = 0, opacityMode = 0, colorMode = 0;
        ...
        {
            float focus = (float)(Math.Abs(z * 0.03f - currentFocus));
