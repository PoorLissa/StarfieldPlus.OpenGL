...
namespace my
{
    public class myObj_0640 : myObject
    {
        // Priority
        public static int Priority => 23;
		public static System.Type Type => typeof(myObj_0640);
        ...
        protected override void generateNew()
        {
            ...
            // Check if this rectangle intersects any other existing rectangles:
            {
                ...
                for (int i = 0; isOk && i < Count; i++)
                {
                    if (i != this.id)
                    {
                        var other = list[i] as myObj_0640;
