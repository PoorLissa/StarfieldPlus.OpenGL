...
namespace my
{
    public class myObj_1570 : myObject
    {
        // Priority
        ...
        private float angle, dAngle, rad;
        ...
        protected override void Show()
        {
            ...
            for (int i = 0; i < edges.Length; i += 4)
            {
                ...
                myPrimitive._LineInst.setInstanceColor(R, G, B, 5 * A / z);
            }
