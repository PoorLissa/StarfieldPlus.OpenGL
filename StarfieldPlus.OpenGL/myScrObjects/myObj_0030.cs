...
namespace my
{
    public class myObj_0030 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0030);
        ...
        protected override void Show()
        {
            switch (shapeType)
            {
                case 0:
                    ...
                    myPrimitive._RectangleInst.setInstanceColor(R, G, B, A/2);
