...
namespace my
{
    public class myObj_0490 : myObject
    {
        // Priority
        public static int Priority => 10;
        public static System.Type Type => typeof(myObj_0490);
...
additiveFunc = 0;
        ...
        protected override void setNextMode()
        {
            ...
            foreach (myObj_0490 obj in list)
                obj.generateNew();
