...
namespace my
{
    public class myObj_0021 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0021);
        ...
        protected override void Show()
        {
            if (size > 0)
            {
                ...
                switch (shape)
                {
                    ...
                    case 2:
                        myPrimitive._EllipseInst.setInstanceCoords(x, y, sizeX2, angle);
                        myPrimitive._EllipseInst.setInstanceColor(R, G, B, A);
                        break;

                    case 3:
                        myPrimitive._PentagonInst.setInstanceCoords(x, y, sizeX2, angle);
                        myPrimitive._PentagonInst.setInstanceColor(R, G, B, A);
                        break;

                    case 4:
                        myPrimitive._HexagonInst.setInstanceCoords(x, y, sizeX2, angle);
