                    ...
                    else
                    {
                        ...
                        if (dx > 0)
                        {
                            if (prm_i[2] == 0 || prm_i[2] == 1)
                            {
                                ...
                                foreach (myObj_0330 obj in list)
                ...
                case 58:
                    {
                        ...
                        if (p == null)
                        {
                            var prm = new p58_myObj_0330();
                            p = prm;

                            if (p58_myObj_0330._list1 == null)
                            {
                ...
                case 63:
                    {
                        ...
                        switch (prm_i[0])
                        {
                            ...
                            case 5:
                                if (index != -1)
                                {
                                    X = (list[index] as myObj_0330).x + (list[index] as myObj_0330).width / 2;
                                    Y = (list[index] as myObj_0330).y + (list[index] as myObj_0330).width / 2;
                                }
                                break;
                        }
