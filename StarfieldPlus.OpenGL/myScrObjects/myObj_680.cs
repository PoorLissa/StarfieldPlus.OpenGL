...
namespace my
{
    public class myObj_680 : myObject
    {
        class symbolItem
        {
            public int index;
		...
		public static System.Type Type => typeof(myObj_680);
        ...
        protected override void Process(Window window)
        {
...

            {
                while (list.Count < N)
                {
                    list.Add(new myObj_680());
                }

                (list[0] as myObj_680).isDead = false;
            }
            ...
            while (!Glfw.WindowShouldClose(window))
            {
                ...
                // Render Frame
                {
                    ...
                    // Generate next row
                    {
                        var topmost = list[idx] as myObj_680;
