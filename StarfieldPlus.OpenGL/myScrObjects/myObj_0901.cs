...
namespace my
{
    public class myObj_0901 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0901);
        ...
        protected override void generateNew()
        {
            ...
            else
            {
                if (ptr >= 0)
                {
                    var parent = list[ptr] as myObj_0901;
        ...
        protected override void Move()
        {
            if (id < n)
            {
                ...
                if (ptr < 0)
                {
                    ...
                    if (ptr > 0)
                    {
                        var obj = list[ptr] as myObj_0901;
                        obj.ptr = (int)id;
                        obj.generateNew();
                        obj.ptr = 0;
                    }
                ...
                else
                {
                    ...
                    var child = list[ptr] as myObj_0901;
        ...
        protected override void Show()
        {
            if (ptr >= 0)
            {
                ...
                {
                    var next = list[ptr] as myObj_0901;
