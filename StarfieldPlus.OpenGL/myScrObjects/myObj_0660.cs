...
namespace my
{
    public class myObj_0660 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0660);
        ...
        protected override void Move()
        {
            ...
            if (false)
            {
                var nextObj = list[next] as myObj_0660;
                ...
                // Render Frame
                {
                    ...
                    myPrimitive._LineInst.ResetBuffer();
                    {
                        for (int i = 0; i != Count; i++)
                        {
                            ...
                            if (obj.state != STATE.DEAD)
                            {
                                var nextObj = list[obj.next] as myObj_0660;
                ...
                // Get new shape
                {
                    ...
                    if (cnt > maxCnt && deadCnt >= n)
                    {
                        ...
                        for (int i = 0; i != Count; i++)
                        {
                            ...
                            if (cnt == n)
                            {
                                (list[First] as myObj_0660).next = i;
