...
namespace my
{
    public class myObj_0600 : myObject
    {
        // Priority
        public static int Priority => 10;
        public static System.Type Type => typeof(myObj_0600);
        ...
        protected override void Show()
        {
            ...
            if (id > 0)
            {
                var prev = list[(int)id - 1] as myObj_0600;
