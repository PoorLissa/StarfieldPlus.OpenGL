...
namespace my
{
    public class myObj_0310 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0310);
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                if (obj.left != null || obj.right != null)
                {
                    for (int j = 0; j < list.Count; j++)
                    {
                        if (i != j)
                        {
                            var other = list[i] as myObj_0310;
