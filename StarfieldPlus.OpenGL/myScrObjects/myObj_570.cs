...
namespace my
{
    public class myObj_570 : myObject
    {
        ...
        public static System.Type Type => typeof(myObj_570);

        private int cnt;
        private float x, y;
        private float size, A, R, G, B;

        private List<myObj_570> connections = null;
...
cnt = 1111;
            ...
            {
                connections = new List<myObj_570>();
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    connections.Add(list[pos] as myObj_570);
                }
            }
