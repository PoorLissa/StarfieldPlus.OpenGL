...
namespace my
{
    public class myObj_0370 : myObject
    {
        // Priority
        public static int Priority => 10;
		public static System.Type Type => typeof(myObj_0370);
        ...
        {
            var clrMode = myUtils.randomChance(rand, 1, 11)
